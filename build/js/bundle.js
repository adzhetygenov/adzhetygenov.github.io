...
!function(factory) {
     true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1), __webpack_require__(4), __webpack_require__(3) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
...
(function () {
  var $header = (0, _jquery2.default)('.main-header__inner');
  var $currentScroll = (0, _jquery2.default)(window).scrollTop();
  var $headerCoords = $header.offset().top;

  if ($currentScroll > $headerCoords) {
  ...
  (0, _jquery2.default)(window).on('scroll resize', function () {
    var $newCurrentScroll = (0, _jquery2.default)(window).scrollTop();

    if ($newCurrentScroll > $headerCoords) {
      $header.addClass('_fixed');
    } else {
      $header.removeClass('_fixed');
    }
...
(function () {
  ...
  if (document.getElementById('map')) {
    initMap = function initMap() {
      ...
      myMap.geoObjects.add(new ymaps.Placemark([57.100778, 65.656639], {
        iconCaption: 'улица Республики, 278AcT1'
      }, {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    jsFile.src = 'https://api-maps.yandex.ru/2.1/?lang=ru_RU&onload=window.initMap';
...
(function () {
  var $modalTrigger = (0, _jquery2.default)('.js-modal-link');
  var scrollWidth = void 0;

  var _demoDiv = function demoDiv() {
    _demoDiv = document.createElement('div');
    _demoDiv.style.overflowY = 'scroll';
    _demoDiv.style.width = '50px';
    _demoDiv.style.height = '50px';
    _demoDiv.style.visibility = 'hidden';
    document.body.appendChild(_demoDiv);
    scrollWidth = _demoDiv.offsetWidth - _demoDiv.clientWidth;
    (0, _jquery2.default)('head').append('<style>html._no_scroll { margin-right: ' + scrollWidth + 'px;}</style>');
    return document.body.removeChild(_demoDiv);
  };
  ...
  var modalWindow = function () {
    ...
    return {
      hide: function hide() {
        ...
        (0, _jquery2.default)('html').removeClass('_no_scroll');
      },
      show: function show(e) {
        $currentModal = (0, _jquery2.default)(e).closest('.modal-overlay');
        $currentModal.addClass('_show');
        (0, _jquery2.default)('html').addClass('_no_scroll');
      }
    };
  }();
  ...
  $modalTrigger.each(function () {
    ...
    (0, _jquery2.default)(this).on('click', function (e) {
      e.preventDefault();
      var $modalLink = (0, _jquery2.default)(_this).attr('href');
      modalWindow.show((0, _jquery2.default)($modalLink));
    });
  });

  (0, _jquery2.default)('body').on('click', '.modal-overlay', function (e) {
    var $target = (0, _jquery2.default)(e.target);
    var $overlay = $target.closest('.modal-overlay');
    var $close = $target.closest('.modal-item__close');

    if ($overlay[0] === $target[0] || $close.length) {
      modalWindow.hide();
    }
  }).keydown(function (e) {
    if ((0, _jquery2.default)('.modal-overlay').hasClass('_show')) {
      if (e.which === 27) {
        modalWindow.hide();
      }
    }
...
(function () {
  (0, _jquery2.default)('.js-nav-link').each(function () {
    var _this = this;

    (0, _jquery2.default)(this).on('click', function () {
      var $href = (0, _jquery2.default)(_this).attr('href');
      (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)($href).offset().top
      }, 1000);
    });
  });
})();
...
(function () {
  (0, _jquery2.default)('.js-slider-schemes').each(function () {
    var $slider = (0, _jquery2.default)(this);
    var $leftArrow = $slider.parent().find('.js-slider__left');
    var $rightArrow = $slider.parent().find('.js-slider__right');
  ...
  var $exmpSlider = (0, _jquery2.default)('.examples__slider');
  var $back = $exmpSlider.parent().find('.js-slider__left');
  var $next = $exmpSlider.parent().find('.js-slider__right');
...
(function () {
  (0, _jquery2.default)('.js-tabs__switcher').on('click', function (e) {
    e.preventDefault();

    var $switcher = (0, _jquery2.default)(e.currentTarget);

    if ($switcher.hasClass('_current')) {
      return false;
    }

    var $switcherContainer = $switcher.closest('.js-tabs__switchers');
    var $prevSwitcher = $switcherContainer.find('.js-tabs__switcher._current');
    var $container = $switcher.closest('.js-tabs');
    var $currentTab = $container.find('.js-tabs__pane._current');
    var $nextTab = $switcher.attr('href');

    $prevSwitcher.removeClass('_current');
    $currentTab.removeClass('_current');
    (0, _jquery2.default)($nextTab).addClass('_current');
    $switcher.addClass('_current');
  });
})();
...
var _inputmask = __webpack_require__(17);
...
(function () {
    var phone = new _inputmask2.default('+7(999)999-99-99');
    phone.mask((0, _jquery2.default)('input[type=tel]'));
})();
